# Spring PetClinic Sample Application [![Java CI with Maven](https://github.com/ashaik16/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/ashaik16/spring-petclinic/actions/workflows/maven.yml)
